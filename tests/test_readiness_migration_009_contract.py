...
EXPECTED_HEAD = "011_billing_wallet"
LEGACY_HEAD = "010_billing_core"
...
def test_ready_accepts_complete_schema_at_head_009(client):
...
def test_ready_rejects_legacy_head_008(client):
